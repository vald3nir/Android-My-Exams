...
@Composable
internal fun ShowDeleteExamDialog(
    onConfirm: () -> Unit = {},
    onCancel: () -> Unit = {}
) {
    ToolkitAlertDialog(
        title = stringResource(R.string.delete_exam_confirm_title),
        description = stringResource(R.string.delete_exam_confirm_description),
        btnConfirmLabel = stringResource(R.string.btn_remove),
        btnCancelLabel = stringResource(R.string.btn_cancel),
        onConfirm = onConfirm,
        onCancel = onCancel,
    )
