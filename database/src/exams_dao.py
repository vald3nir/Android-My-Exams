...
from keys.saude_secret import FIREBASE_CONFIG, FIREBASE_CERTIFICATE
...
class ExamsDAO(Firebase):
    ...
    def __init__(self) -> None:
        super().__init__(firebase_config=FIREBASE_CONFIG, firebase_certificate=FIREBASE_CERTIFICATE)
